...
class TestDashboardLoaders:
    ...
    def test_load_status(self, mock_memory_store):
        from openclaw_colab_agent.tools.dashboard import load_status
    ...
    def test_load_experiments_empty(self, mock_memory_store):
        from openclaw_colab_agent.tools.dashboard import load_experiments
    ...
    def test_load_errors_empty(self, mock_memory_store):
        from openclaw_colab_agent.tools.dashboard import load_errors
    ...
    def test_load_heartbeat_empty(self, mock_memory_store):
        from openclaw_colab_agent.tools.dashboard import load_heartbeat
    ...
    def test_load_datasets_empty(self, mock_memory_store):
        from openclaw_colab_agent.tools.dashboard import load_datasets
        result = load_datasets(mock_memory_store)
        assert isinstance(result, str)

    def test_run_action_refresh(self, mock_memory_store):
        from openclaw_colab_agent.tools.dashboard import run_action
...
class TestDashboardUI:
    ...
    def test_safe_json(self):
        from openclaw_colab_agent.tools.dashboard import _safe_json
        result = _safe_json({"a": 1, "b": [2, 3]})
        assert '"a": 1' in result

    def test_fmt_time(self):
        from openclaw_colab_agent.tools.dashboard import _fmt_time
